...
import type { Card, MarketsCard } from '../lib/cards';
import type { Asset, Skill, Player } from '../lib/game-types';
import { useGame } from '../lib/game-context';
import type { CardEffect } from '../lib/game-context';
...
function parseEventEffect(card: Card, player: Player): CardEffect {
  ...
  let activeEffectToAdd: import('../lib/game-types').ActiveEffect | undefined;
